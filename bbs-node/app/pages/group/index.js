...
class App {
    constructor() {
        ...
        const { tagId, tabType, hotUsers, downLoadUrl, pageTitle }  = initData;
    ...
    bindEvents() {
        ...
        const EVENTS = {
            ...
            '.js-subscribe': {
                click: (e) => {
                    ...
                    request({
                        ...
                        if(ret.data.length>=30){
                            Toast('您已加入30个小组，不能再加入');
                            return false;
                        }else{
                            return true;
                        }
            ...
            '.js-new-post': {
                click: (e) => {
                    e.preventDefault();
                    const { tagId,pageTitle } = this.state;
